...
public class WoundMultiStageTimedDialogueTriggerZone : MonoBehaviour
{
    [System.Serializable]
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (showWrongFeedbackWhenNotAtStage && Time.time - lastWrongTime >= wrongFeedbackCooldown)
        {
            ...
            ScoreManager.Instance?.RegisterMistake(
                dialogueManager != null ? dialogueManager.GetCurrentSegmentName() : "Unknown",
                dialogueManager != null ? dialogueManager.GetCurrentLineIndex() : -1,
